...
class GasChartViewController: UIViewController, ChartViewDelegate {
    ...
    func getDataFirebase() {
        ...
        firebaseReference.observeSingleEvent(of: .value, with: { snapshot in
                    for child in snapshot.children {
                        ...
                        var firebaseData: GasChartViewController.firebaseData = GasChartViewController.firebaseData(date: snap.key, temp: placeDict["temp"] as! Float, hum: placeDict["hum"] as! Float, gas: placeDict["gas"] as! Float)
