...
class HumChartViewController: UIViewController, ChartViewDelegate {
    ...
    func getDataFirebase() {
        ...
        firebaseReference.observeSingleEvent(of: .value, with: { snapshot in
                    for child in snapshot.children {
                        ...
                        var firebaseData: HumChartViewController.firebaseData = HumChartViewController.firebaseData(date: snap.key, temp: placeDict["temp"] as! Float, hum: placeDict["hum"] as! Float, gas: placeDict["gas"] as! Float)
